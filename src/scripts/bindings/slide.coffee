# Works like the default visible binding but slides the content in and out
# Examples:
#   <div data-bind='slide: trueFalseObservable' />
ko.bindingHandlers.slide = update: (element, valueAccessor) ->
  ...
  if shouldShow and !isCurrentlyVisible
    $(element).stop(true, true).css('display', 'none').slideDown duration, ->
