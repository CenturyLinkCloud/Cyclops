  ...
  validator: (val, options) ->
    ...
    if badCharacters.length > 0
      ...
      if options.requiredStrength >= 4
        @message = 'A password must be at least 8 characters and contain all of the following: ' + '<ul>' + '<li>uppercase letters</li>' + '<li>lowercase letters</li>' + '<li>numbers</li>' + '<li>symbols</li>' + '</ul>'
        ...
        @message = 'A password must be at least 8 characters and contain at least 2 of the following: ' + '<ul>' + '<li>uppercase letters</li>' + '<li>lowercase letters</li>' + '<li>numbers</li>' + '<li>symbols</li>' + '</ul>'
      else
